      ...
      <div className="card animate-fade-in text-center">
        <div className="mb-6">
          ...
          <p className="page-subtitle">
            Solution sent to your inbox<br />
            <strong>{email}</strong>
          </p>
        </div>
  ...
  return (
    <div className="card animate-fade-in">
      <div className="text-center mb-8">
        <div className="mb-4">
          <span className="text-6xl text-blue-900 animate-float">?</span>
        </div>
        <h1 className="page-title">Forgot Password?</h1>
        <p className="page-subtitle">
          Let's solve for x • x = your password
        </p>
      </div>
      ...
      <div className="mt-6">
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-2 bg-white text-gray-500">Or try signing in with</span>
          </div>
        </div>
