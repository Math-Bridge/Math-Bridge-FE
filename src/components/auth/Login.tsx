    ...
    <div className="card animate-scale-in hover-glow">
      ...
      <div className="mt-6">
        ...
        <div className="mt-4 w-full flex items-center justify-center">
          <button
            type="button"
            className="w-full flex items-center justify-center px-4 py-3 border border-navy-200 rounded-lg bg-white text-gray-700 hover:bg-navy-50 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-navy-500 focus:ring-offset-2 hover-lift"
