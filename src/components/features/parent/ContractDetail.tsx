...
import { getContractById, getContractsByParent, apiService, createContractDirectPayment, SePayPaymentResponse, getFinalFeedbackByContractAndProvider, getFinalFeedbacksByUserId, FinalFeedback, getChildUnitProgress, ChildUnitProgress, getDailyReportsByContract, DailyReport, getTutorVerificationByUserId } from '../../../services/api';
  ...
  useEffect(() => {
    const fetchDailyReports = async () => {
      ...
      try {
        ...
        // Use contract ID directly to fetch daily reports
        const reportsResult = await getDailyReportsByContract(contract.id);
