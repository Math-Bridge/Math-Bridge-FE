...
const Layout: React.FC = () => {
          ...
          <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
            ...
            <div className="absolute inset-0 flex items-center justify-center animate-slide-in-left">
              <div className="text-white text-center">
                ...
                <h2 className="text-3xl font-bold mb-2 animate-fade-in stagger-1">MathDash</h2>
                <p className="text-xl opacity-90 animate-fade-in stagger-2">Connecting quality math tutors</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 w-full px-4 sm:px-6 lg:px-8 py-8 math-bg-pattern">
        <Outlet />
      </main>
